    ...
    <Section className="grid items-center gap-12 py-16 md:grid-cols-2 md:py-24">
      <motion.div initial="hidden" animate="show" variants={fadeUp}>
        ...
        <p className="mt-5 max-w-md text-lg leading-relaxed text-muted-foreground">
          Zakažite pregled online za nekoliko sekundi. Iskusan tim, bezbolne procedure i pristup
          posvećen svakom pacijentu.
        </p>
  ...
  return (
    <Section className="py-16">
      <div className="mb-10 flex flex-col items-center text-center">
        <h2 className="font-heading text-3xl font-bold text-foreground sm:text-4xl">Naš tim</h2>
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {doctors.slice(0, 8).map((d, i) => (
          ...
          >
            ...
            >
              <Avatar name={`${d.firstName} ${d.lastName}`} size={84} />
      ...
      <div className="mt-8 text-center">
        <Link to="/team">
          <Button variant="outline">Pogledaj ceo tim <ArrowRight size={16} /></Button>
        </Link>
      </div>
    </Section>
  )
...
export default function HomePage() {
  return (
    <PageWrapper
      ...
      description={`${CLINIC.name} — ${CLINIC.tagline}. Zakažite stomatološki pregled online u Beogradu.`}
    >
      <Hero />
      <Stats />
      <ServicesPreview />
