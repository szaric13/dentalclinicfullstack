export const CLINIC = {
  ...
  phoneHref: "+381111234567",
  email: "ordinacija@denta.rs",
...
export const SPECIALTIES = [
  {
    ...
    name: "Opšta stomatologija",
    short: "Redovni pregledi, plombe i prevencija.",
    description:
      "Opšta stomatologija obuhvata redovne kontrole, dijagnostiku, lečenje karijesa, estetske plombe i savete za očuvanje oralnog zdravlja. Naš tim koristi savremenu opremu kako bi svaki pregled bio bezbolan i prijatan.",
  },
  {
    slug: "ortodoncija",
    name: "Ortodoncija",
    short: "Fiksne i providne folije za savršen osmeh.",
    description:
      "Ortodoncija ispravlja položaj zuba i vilica pomoću fiksnih aparatića i providnih folija (alignera). Rezultat je harmoničan osmeh i pravilan zagriz.",
  },
  {
    slug: "oralna-hirurgija",
    name: "Oralna hirurgija",
    short: "Vađenje, apikotomije i hirurške intervencije.",
    description:
      "Oralna hirurgija obuhvata vađenje umnjaka, hirurško lečenje cista i druge intervencije uz maksimalnu udobnost i savremene protokole anestezije.",
  },
  {
    slug: "implantologija",
    name: "Implantologija",
    short: "Trajna rešenja za nedostajuće zube.",
    description:
      "Implantologija nudi trajno rešenje za nedostajuće zube uz pomoć titanijumskih implantata koji u potpunosti zamenjuju prirodni koren zuba.",
  },
  {
    slug: "protetika",
    name: "Protetika",
    ...
    description:
      "Protetika vraća funkciju i estetiku osmeha pomoću krunica, mostova i navlaka izrađenih od najkvalitetnijih materijala.",
  },
  {
...
export const NURSES = [
  {
    ...
    name: "Nadica Vujić",
    role: "Glavna sestra",
    bio: "Nadica koordinira rad ordinacije više od 15 godina i brine da svaki pacijent bude dočekan toplo i profesionalno.",
    education: "Viša medicinska škola, smer stomatološka sestra",
    image: "/images/nurse-1.png",
  },
  {
    slug: "tanja-lekic",
    name: "Tanja Lekić",
    role: "Stomatološka sestra",
    bio: "Tanja asistira u hirurškim i protetskim zahvatima i poznata je po smirenom pristupu pacijentima.",
  ...
  },
  {
    ...
    name: "Danka Matana",
    role: "Stomatološka sestra",
    bio: "Danka vodi računa o sterilizaciji i pripremi ordinacije, sa posebnim fokusom na rad sa decom.",
    education: "Srednja medicinska škola, smer pedijatrijska nega",
    image: "/images/nurse-3.png",
  },
]
...
export const FAQ = [
  {
    ...
    a: "Termin možete zakazati online kroz našu platformu nakon registracije, ili pozivom na +381 11 123 4567. Online zakazivanje vam omogućava da odaberete lekara, uslugu i slobodan termin.",
  },
  {
  ...
  },
  {
    ...
    a: "Radimo radnim danima od 08:00 do 19:00 i subotom od 08:00 do 12:00. Nedeljom ne radimo.",
  },
]
